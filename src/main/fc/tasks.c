...
task_attribute_t task_attributes[TASK_COUNT] = {
    ...
    [TASK_THROTTLE_CONTROL] = DEFINE_TASK("THROTTLE_CONTROL", NULL, NULL, throttleControlUpdate, TASK_PERIOD_HZ(THROTTLE_CONTROL_TASK_RATE_HZ), TASK_PRIORITY_MEDIUM_HIGH),
#endif
