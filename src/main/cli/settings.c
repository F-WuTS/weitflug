...
// PG_ACCELEROMETER_CONFIG
    ...
    { "acc_notch_hz",              VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, LPF_MAX_HZ }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_soft_notch_hz) },
    { "acc_notch_cutoff",          VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, LPF_MAX_HZ }, PG_ACCELEROMETER_CONFIG, offsetof(accelerometerConfig_t, acc_soft_notch_cutoff) },
...
// PG_TIMECONFIG
    ...
    { PARAM_NAME_ACC_RPM_FILTER_HARMONICS,     VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 3 }, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_harmonics) },
    { PARAM_NAME_ACC_RPM_FILTER_WEIGHTS,       VAR_UINT8 | MASTER_VALUE | MODE_ARRAY, .config.array.length = RPM_FILTER_HARMONICS_MAX, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_weights) },
    { PARAM_NAME_ACC_RPM_FILTER_Q,             VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 250, 3000 }, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_q) },
    { PARAM_NAME_ACC_RPM_FILTER_MIN_HZ,        VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 30, 200 }, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_min_hz) },
    { PARAM_NAME_ACC_RPM_FILTER_FADE_RANGE_HZ, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 1000 }, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_fade_range_hz) },
    { PARAM_NAME_ACC_RPM_FILTER_LPF_HZ,        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 100, 500 }, PG_ACC_RPM_FILTER_CONFIG, offsetof(rpmFilterConfig_t, rpm_filter_lpf_hz) },
#endif
...
// PG_THROTTLE_CONTROL_CONFIG
    ...
    { "throttle_control_max_rpm", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 40000 }, PG_THROTTLE_CONTROL_CONFIG, offsetof(throttleControlConfig_t, throttle_max_rpm) },
